...
class BuildingPlacementSolver:
    ...
    def draw_debug(self):
        ...
        for p in self.building_positions_priority_1:
            ...
            color = red
            draw_addon = True
            self.draw_debug_single(pos2=pos, size=size, color=color, draw_addon=draw_addon)
    ...
    def draw_debug_single(self, pos2=Point2((0, 0)), size=0.45, color=Point3((255, 255, 255)), draw_addon=False):
        p2 = Point2(pos2)
        h2 = self.ai.get_terrain_z_height(p2)
        pos = Point3((p2.x, p2.y, h2))
        h = 0.3
        point0 = Point3((pos.x - size, pos.y - size, pos.z + h))
        ...
        if draw_addon:
            ...
            point0 = Point3((pos.x - 0.95, pos.y - 0.95, pos.z + h))
