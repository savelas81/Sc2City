    ...
    def sequence(self) -> typing.List[typing.Any]:
        return [
            UnitRequest(
                ...
                target_value_or_quantity_value=20
            ),
            BuildRequest(
            ...
            BuildRequest(
                ...
                target_value_or_quantity_value=2,
                """
                # Build it near the barrack with reactor
                """
            ),
            BuildRequest(
                ID=UnitTypeId.BARRACKS,
            ...
            """
            # 1:57 Set amount of gas miners worldwide to 4
            """
            BuildRequest(
                ID=UnitTypeId.SUPPLYDEPOT,
                AI=self.AI,
            ...
            """
            # Lift the barrack from its reactor and put the factory there
            """
            BuildRequest(
                ID=UnitTypeId.SUPPLYDEPOT,
                AI=self.AI,
            ...
            """
            # Always produce 2 at a time, highest priority
            """
            UnitRequest(
                conditional=None,
                AI=self.AI,
            ...
            """
            # Always produce 1 at a time, Second priority
            """
            UnitRequest(
                conditional=None,
                AI=self.AI,
            ...
            """
            # Use the rest of the resources on marines
            """ 
        """
